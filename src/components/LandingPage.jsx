...
const SEARCH_ENGINE_URL = 
  ...
  (typeof window !== 'undefined' && (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1')
    ? 'http://localhost:3000'
    : 'https://velvet-paragraph-retreat-pharmacies.trycloudflare.com');

const ORDER_DTE_URL = 
  import.meta.env?.VITE_ORDER_DTE_URL || 
  (typeof window !== 'undefined' && (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1')
    ? 'http://localhost:5173'
    : 'https://editors-train-stores-seriously.trycloudflare.com');
          ...
          <div className="lp-search-banner-inner">
            <div className="lp-search-banner-left">
              <div className="lp-search-banner-badge">
                ...
                <span>PROYEK SEARCH ENGINE RESMI</span>
              </div>
              <h3 className="lp-search-banner-title">
                Kami Telah Mengembangkan Proyek Search Engine Kami! 🔍
              </h3>
              <p className="lp-search-banner-desc">
                Coba mesin pencari mandiri DeeperNova — pencarian berkecepatan tinggi sub-20ms, relevansi informasi presisi, indeks 39GB+ real-time, dan anti-typo cerdas.
              </p>
            </div>
