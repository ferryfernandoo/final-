    ...
    try {
      ...
      if (isGuestMode) {
        ...
        try {
          ...
          if (!directKey) {
            throw new Error('API Key TokenMix (VITE_TOKENMIX_API_KEY) tidak ditemukan. Jika Anda menggunakan Vercel, harap tambahkan VITE_TOKENMIX_API_KEY di pengaturan Environment Variables Vercel Anda.');
          }
