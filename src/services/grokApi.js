...
const getDeepseekApiKey = () => {
  try {
    ...
    if (typeof process !== 'undefined' && process.env) {
      ...
      if (process.env.TOKENMIX_CHAT_API_KEY) return process.env.TOKENMIX_CHAT_API_KEY;
      if (process.env.VITE_TOKENMIX_API_KEY) return process.env.VITE_TOKENMIX_API_KEY;
...
const sendMessageViaBackend = async (message, conversationHistory = [], language = 'id', personality = DEFAULT_PERSONALITY, abortController = null, deepernovaModel = 'llama-4-maverick', userName = '', sessionMessageCount = 0, uploadedImages = [], globalMemory = '', conversationId = null) => {
