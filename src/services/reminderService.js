...
class ReminderService {
  ...
  addReminder({ title, datetime, type = 'reminder', description = '', repeat = 'none', location = '' }) {
    ...
    // Trigger Native Android Notification / Calendar Event if on native app
    ...
    if (type === 'alarm') {
      nativeBridge.createNativeAlarm(newReminder);
    } else if (type === 'calendar' || type === 'reminder') {
      nativeBridge.createCalendarEvent(newReminder);
    }
